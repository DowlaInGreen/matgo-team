    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-[1200px] mx-auto px-6 pt-32 pb-20 grid lg:grid-cols-2 gap-16 items-center relative z-10">
          <div>
            ...
            <div className="animate-fade-in-up delay-300 flex gap-4 flex-wrap">
              ...
              <a href="#projekti" className="btn-secondary">
                Pogledaj radove
              </a>
            </div>
      ...
      <section className="py-20 px-6 bg-gradient-to-br from-primary to-primary-dark relative overflow-hidden">
        ...
        <div className="max-w-[800px] mx-auto text-center relative z-10">
          ...
          <a 
            href="#kontakt" 
            className="inline-flex items-center gap-2 bg-white text-primary px-10 py-4 rounded-lg font-montserrat font-bold text-base hover:shadow-xl transition-all"
          >
            <Phone size={20} />
            Zatraži ponudu
          </a>
              ...
              <div className="flex flex-col gap-6">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <div className="text-gray-600">+385 XX XXX XXXX</div>
                  </div>
                </div>
